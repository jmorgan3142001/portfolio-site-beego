document.addEventListener('DOMContentLoaded', () => {
    ...
    const printLine = (text, isAscii = false) => {
        const line = document.createElement('div');
        line.className = isAscii ? 'ascii-art mb-1' : 'text-mono small mb-1';
    ...
    const commands = {
        ...
        'dog': () => {
            printLine("Usage: Woof, wag, and whine!");
            printLine(asciiArt.dog, true);
            return "";
        },

        'pit': () => {
            printLine("Usage: Pitbulls are banned in 12 countries! (but not this terminal)");
            printLine(asciiArt.dog, true);
            return "";
        },

        'staff': () => {
            printLine("Usage: This Staffy's tail is a registered weapon!");
            printLine(asciiArt.dog, true);
            return "";
        },
